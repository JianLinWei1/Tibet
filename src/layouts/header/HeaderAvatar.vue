    ...
    <a-modal v-model="visible" title="修改密码" @ok="handleOk">
      <a-form-model :model="form">
        <a-form-model-item label="旧密码">
          <a-input type="password" v-model="form.oldPw" placeholder="请输入旧密码" />
        </a-form-model-item>
        <a-form-model-item label="新密码">
          <a-input type="password" v-model="form.newPw" placeholder="请输入新密码" />
        </a-form-model-item>
        <a-form-model-item label="确认新密码">
          <a-input type="password" v-model="form.newPw2" placeholder="确认新密码" />
        </a-form-model-item>
      </a-form-model>
    </a-modal>
  </div>
